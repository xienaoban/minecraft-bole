...
public class BolePandaEntityScreenHandler<E extends PandaEntity> extends BoleAnimalEntityScreenHandler<E> {
    public static final ScreenHandlerType<BolePandaEntityScreenHandler<PandaEntity>> HANDLER
            = register(new Identifier(Keys.NAMESPACE, "panda_entity"), BolePandaEntityScreenHandler::new);
